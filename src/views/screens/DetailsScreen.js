...
const DetailsScreen = ({navigation, route}) => {
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}>
      ...
      <View style={{marginTop:40,flexDirection:'row',justifyContent:"space-between",padding:30}}>

            <View>

            <TouchableOpacity onPress={()=>navigation.navigate("Good Chart", {"selectedCategoryIndex":selectedCategoryIndex, "pet":pet})} style={{width:60,height:60,borderRadius:5,borderColor:'#F2F3F5',backgroundColor:"#F2F3F5",padding:10}}>
              <Image source={require('../../assets/food_chart.png')} style={{width:'100%',height:'100%'}}/>
            </TouchableOpacity>
            <Text style={{textAlign:"center",fontWeight:"bold"}}>Food Chart</Text>
            </View>
            ...
            }} style={{width:60,height:60,borderRadius:5,borderWidth:1,borderColor:'#F2F3F5',backgroundColor:"#F2F3F5",padding:10,marginLeft:20}}>
              <Image source={require('../../assets/doctor.png')} style={{width:'100%',height:'100%'}}/>
            </TouchableOpacity>
            <Text style={{textAlign:"center",fontWeight:'bold'}}>Vet Recommendation</Text>
            ...
            }} style={{width:60,height:60,borderRadius:5,borderColor:'#F2F3F5',backgroundColor:"#F2F3F5",padding:10,marginLeft:20}}>
              <Image source={require('../../assets/medicines.png')} style={{width:'100%',height:'100%'}}/>
            </TouchableOpacity>
      ...
      {/* Comment container */}
      <View style={{marginTop: 30, justifyContent: 'space-between', flex: 1}}>
        <View>
